...
\title{\Huge \textbf{Práctica 5: Sistema de Autenticación Biométrica Segura y Sistema de Alerta ante Detección de Datos Anómalos}}
...
\begin{titlepage}
    ...
    {\Huge \textbf{Práctica 5: Sistema de Autenticación Biométrica Segura y Sistema de Alerta ante Detección de Datos Anómalos} \par}
    \vspace{1.5cm}
