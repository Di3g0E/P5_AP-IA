...
Cuantitativamente, la Figura~\ref{fig:roc_liveness} presenta la curva ROC del detector y la Figura~\ref{fig:score_dist_liveness} la distribución de \textit{scores} para ambas clases, lo que permite observar la separabilidad alcanzada y justificar la elección del umbral de operación. La matriz de confusión resultante (Figura~\ref{fig:confusion_liveness}) resume los aciertos y errores de clasificación, ofreciendo una lectura directa de los falsos aceptos y falsos rechazos del sistema.
